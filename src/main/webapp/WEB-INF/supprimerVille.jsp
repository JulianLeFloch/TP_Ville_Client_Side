...
<title>Ville bien supprimée</title>
<link rel="stylesheet"
		...
		<table id="table_villes"
			...
			<tbody>
					<tr>
						...
						<td><c:out value="${ ville.getCodeCommuneInsee() }"></c:out></td>
						...
						<td><c:out value="${ ville.getLatitude() }"></c:out></td>
						<td><c:out value="${ ville.getLongitude() }"></c:out></td>
					</tr>
			</tbody>
		</table>
